...
grow(){
    statistics.points.castle=this.points
    if(this.points>=1000){
this.g+=Math.floor((this.points/1000))
        ...
        for (var i in newCell){
            ...
            if (DestroyerArr.length!=0){
                if (newX==DestroyerArr[0].x && newY==DestroyerArr[0].y){
    ...
    this.g-=1
    var newCell = this.chooseCell(this.g);
    statistics.stage.castle=this.g
